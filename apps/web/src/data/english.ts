...
export const LESSON_THEORY: Record<string, string> = {
  'a1-tobe': 'El verbo "to be" (ser/estar) es el más importante del inglés. Cambia según el sujeto: I am · you/we/they are · he/she/it is.\nEjemplo: "She is a developer" (Ella es programadora). Para preguntar, invierte: "Are you ready?".\nOjo: en inglés SIEMPRE va el sujeto — se dice "I am tired", nunca solo "Am tired".',
  'a1-articles': 'Los artículos indefinidos: "a" antes de sonido consonántico (a cat) y "an" antes de sonido vocálico (an apple, an hour). El definido "the" es para algo específico o ya mencionado.\nEjemplo: "I saw a dog. The dog was big."\nOjo: se guía por el SONIDO, no la letra: "a university" (suena /iu/), "an hour" (la h es muda).',
  'a1-vocab': 'El vocabulario se pega mejor en frases y con imágenes, no como palabras sueltas. Agrupa por temas (casa, trabajo, comida).\nEjemplo: en vez de memorizar "chair", aprende "Sit on the chair".\nOjo: repasa con repetición espaciada (hoy, mañana, en 3 días) — así pasa a memoria de largo plazo.',
  'a1-numbers': 'Números y colores son la base para precios, horas, edades y descripciones. Practícalos en voz alta.\nEjemplo: "It costs fifteen dollars" · "The red car".\nOjo: 13-19 terminan en -teen (thirTEEN) y 20-90 en -ty (thirTY); el acento cambia y confunde al escuchar.',
  'a1-plurals': 'Plural regular = +s. Si termina en -s/-x/-ch/-sh → +es (boxes). Consonante + y → -ies (city→cities).\nEjemplo: "two watches", "three babies".\nOjo: hay irregulares que hay que memorizar: man→men, woman→women, child→children, foot→feet, person→people.',
  'a1-family': 'Vocabulario de familia para presentarte y hablar de ti: mother, father, brother, sister, grandparents, son, daughter.\nEjemplo: "I have one sister and two brothers".\nOjo: para posesión usa \'s: "my mother\'s name" (el nombre de mi madre).',
  'a2-present': 'Present Simple = rutinas, hábitos y verdades generales. En 3ª persona (he/she/it) el verbo lleva -s.\nEjemplo: "I work from home. She works at a bank."\nOjo: en negativo/pregunta el -s se va al auxiliar: "She doesn\'t work" (NO "doesn\'t works"), "Does he work?".',
  'a2-prep': 'Preposiciones de lugar: in (dentro de un espacio: in the room), on (sobre una superficie: on the table), at (punto concreto: at home, at work).\nEjemplo: "The keys are on the desk, in the drawer."\nOjo: son idiomáticas — "at" para lugares específicos, "in" para ciudades/países (in Mexico).',
  'a2-future': 'Dos futuros: "will" para decisiones del momento y predicciones; "going to" para planes ya decididos y evidencia presente.\nEjemplo: "I\'ll help you" (decisión ahora) vs "I\'m going to study tonight" (plan).\nOjo: con evidencia clara se usa going to: "Look at those clouds — it\'s going to rain".',
  'a2-there': '"There is" para singular/incontable; "There are" para plural. Expresan existencia ("hay").\nEjemplo: "There is a problem" · "There are three options".\nOjo: no lo confundas con "it is" (eso es): "There is a cat" (hay un gato) ≠ "It is a cat" (es un gato).',
  'a2-food': 'Vocabulario de comida y de pedir en restaurantes: order, bill, waiter, menu, starter, main course.\nEjemplo: "Could I have the menu, please?" · "I\'ll have the chicken."\nOjo: distingue contables (an apple, two apples) de incontables (some water, some rice — sin plural).',
  'b1-pastperf': 'Past Simple = acción terminada (I went). Past Continuous = acción en progreso en el pasado (I was going), a menudo interrumpida.\nEjemplo: "I was cooking when the phone rang."\nOjo: los verbos irregulares en pasado hay que memorizarlos: go→went, buy→bought, think→thought.',
  'b1-phrasal': 'Los phrasal verbs (verbo + partícula) cambian totalmente de significado. Apréndelos como una unidad y en contexto.\nEjemplo: "give up" (rendirse), "look for" (buscar), "turn on" (encender).\nOjo: algunos son separables: "turn it on" ✓ / "turn on it" ✗. Aprende el patrón con ejemplos.',
  'b1-reading': 'Estrategia de comprensión lectora: primero capta la idea general (skimming), luego busca datos concretos (scanning). No traduzcas palabra por palabra.\nEjemplo: lee un artículo y resume la idea en una frase antes de ver los detalles.\nOjo: adivina el significado por contexto; no pares en cada palabra desconocida.',
  'b1-presperf': 'Present Perfect (have/has + participio) conecta pasado y presente: experiencias, algo reciente, o no terminado.\nEjemplo: "I have worked here for two years" (y sigo aquí).\nOjo: "for" = duración (for 2 years), "since" = punto de inicio (since 2022). No uses Past Simple con "yet/already".',
  'b1-business': 'Inglés laboral esencial para entrevistas y correos: meeting, deadline, hire, salary, apply, skills, remote.\nEjemplo: "I\'d like to apply for the developer position."\nOjo: en correos formales usa "I would like to…" y cierra con "Best regards,". Clave para tu meta en Vancouver.',
  'b1-modals': 'Verbos modales (no cambian de forma): can (habilidad), should (consejo), must/mustn\'t (obligación/prohibición), may (permiso).\nEjemplo: "You should rest" · "You must save your work."\nOjo: tras un modal va el verbo en base sin "to": "I can help" (NO "can to help").',
  'b2-conditionals': 'Condicionales: 1º (real): if + presente, will → "If you study, you will pass". 2º (irreal presente): if + pasado, would → "If I had money, I would travel". 3º (pasado): if + had + participio, would have → "If I had studied, I would have passed".\nOjo: en el 2º condicional se usa "were" para todos: "If I were you…".',
  'b2-passive': 'La voz pasiva = be + participio. Se usa cuando importa la acción/objeto, no quién la hace.\nEjemplo: "The app was built in React" · "English is spoken here."\nOjo: el agente (quién) es opcional y va con "by": "The bug was fixed by the team."',
  'b2-relative': 'Pronombres relativos unen ideas: who (personas), which/that (cosas), where (lugar), whose (posesión), when (tiempo).\nEjemplo: "The dev who wrote this…" · "The city where I live…".\nOjo: "that" sirve para personas y cosas en frases especificativas; "which" no se usa para personas.',
  'b2-reported': 'Estilo indirecto (reported speech): el tiempo "retrocede" (am→was, will→would, can→could) y cambian pronombres.\nEjemplo: "I am tired" → "He said he was tired."\nOjo: en preguntas reportadas el orden vuelve a ser normal: "Where do you live?" → "She asked where I lived."',
  'c1-idioms': 'Los idioms (modismos) no se traducen literal: hay que aprender el significado completo.\nEjemplo: "break the ice" (romper el hielo), "hit the books" (ponerse a estudiar), "piece of cake" (facilísimo).\nOjo: úsalos con moderación y en el registro correcto — suenan raros si los fuerzas.',
